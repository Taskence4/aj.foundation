  ...
  return (
    <footer className="site-footer">
      ...
      <div className="site-shell footer-main">
        <div className="footer-brand"><Image className="footer-logo brand-logo-light" src="/brand/aj-foundation-transparent.webp" alt="AJ Foundation" width={360} height={100} /><p>Building skills. Restoring purpose. Preparing lives beyond prison.</p></div>
